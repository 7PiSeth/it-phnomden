...
const khmerContent = {
  ...
  intro: "សង្គ្រាមស៊ីវិលកម្ពុជា (១៩៧០–១៩៧៥) គឺជាជម្លោះប្រវត្តិសាស្ត្រដ៏សំខាន់ និងបំផ្លិចបំផ្លាញ ដែលបានត្រួសត្រាយផ្លូវសម្រាប់អំពើប្រល័យពូជសាសន៍ដ៏អាក្រក់បំផុតមួយក្នុងសតវត្សរ៍ទី២០។ ទោះជាយ៉ាងណាក៏ដោយ ដើម្បីស្វែងយល់ពីភាពស្មុគស្មាញនៃជម្លោះនេះ យើងត្រូវមើលទៅលើកត្តានយោបាយក្នុងតំបន់ និងពិភពលោកដ៏ធំជាងនេះ ដែលរួមមានសង្គ្រាមត្រជាក់ សង្គ្រាមវៀតណាម ការឈ្លានពានរបស់វៀតណាមជាបន្តបន្ទាប់ និងសង្រ្គាមទ័ពព្រៃដែលបានបន្តអូសបន្លាយ។",
  sections: [
    {
      heading: "ឫសគល់នៃជម្លោះ៖ សង្គ្រាមត្រជាក់ និងសង្គ្រាមវៀតណាម",
      body: `ក្នុងអំឡុងសង្រ្គាមត្រជាក់ កម្ពុជាមានតួនាទីជាប្រទេសអព្យាក្រឹតក្រោមការដឹកនាំរបស់ព្រះបាទនរោត្តម សីហនុ។ យ៉ាងណាមិញ ភាពអព្យាក្រឹតនេះពិបាកនឹងរក្សាបានណាស់ ដោយសារតែជម្លោះនៅប្រទេសវៀតណាមដែលនៅជិតខាងបានកើនឡើង។ កងទ័ពវៀតណាមខាងជើង និងកងទ័ពវៀតកុង បានប្រើប្រាស់តំបន់ភាគខាងកើតនៃប្រទេសកម្ពុជាជាមូលដ្ឋាន និងផ្លូវផ្គត់ផ្គង់ ដែលគេស្គាល់ថាជាផ្លូវលំហូជីមិញ ដើម្បីធ្វើប្រតិបត្តិការប្រឆាំងនឹងវៀតណាមខាងត្បូង។
        
        ជាការឆ្លើយតប សហរដ្ឋអាមេរិកក្រោមការដឹកនាំរបស់ប្រធានាធិបតី Richard Nixon បានចាប់ផ្តើមយុទ្ធនាការទម្លាក់គ្រាប់បែកដោយសម្ងាត់ និងទ្រង់ទ្រាយធំនៅក្នុងប្រទេសកម្ពុជាចាប់តាំងពីឆ្នាំ១៩៦៩។ ទោះបីជាគោលដៅគឺដើម្បីរំខានផ្លូវផ្គត់ផ្គង់របស់វៀតណាមខាងជើងក៏ដោយ ក៏យុទ្ធនាការទម្លាក់គ្រាប់បែក និងការឈ្លានពានតាមព្រំដែននេះបានធ្វើឲ្យជនបទកម្ពុជាមានអស្ថិរភាព។ សកម្មភាពយោធាដ៏ធំនេះបានរុញច្រានប្រជាជនកម្ពុជាជនបទជាច្រើននាក់ ដែលបានរងទុក្ខវេទនាពីការបំផ្លិចបំផ្លាញ ឲ្យទៅចូលរួមជាមួយចលនាបះបោររបស់កុម្មុយនិស្តដែលកំពុងរីកចម្រើន គឺខ្មែរក្រហម។`
    },
    {
      heading: "សង្គ្រាមស៊ីវិល និងការងើបឡើងនៃខ្មែរក្រហម (១៩៧០–១៩៧៥)",
      body: `សង្គ្រាមស៊ីវិលបានចាប់ផ្តើមជាផ្លូវការនៅខែមីនា ឆ្នាំ១៩៧០ នៅពេលដែល លន់ នល់ ដោយមានការគាំទ្រពីសហរដ្ឋអាមេរិក បានធ្វើរដ្ឋប្រហារទម្លាក់ព្រះអង្គម្ចាស់សីហនុ។ រដ្ឋាភិបាលថ្មីរបស់ លន់ នល់ ដែលជាសាធារណរដ្ឋខ្មែរ បានគាំទ្រអាមេរិក ប៉ុន្តែបានប្រឈមមុខនឹងការប្រឆាំងភ្លាមៗពីសំណាក់ខ្មែរក្រហម និងសម្ព័ន្ធមិត្តរបស់ខ្លួន។ ព្រះសីហនុ ដែលកំពុងនិរទេសខ្លួននៅប្រទេសចិន បានធ្វើសម្ព័ន្ធភាពគួរឲ្យភ្ញាក់ផ្អើលជាមួយខ្មែរក្រហម ហើយបានអំពាវនាវដល់ប្រជាជនកម្ពុជាឲ្យចូលរួមក្នុងការតស៊ូប្រដាប់អាវុធប្រឆាំងនឹងរបប លន់ នល់។ ការអំពាវនាវនេះបានជំរុញយ៉ាងខ្លាំងដល់ការកើនឡើងចំនួនកងទ័ពរបស់ខ្មែរក្រហម។
        
        ក្នុងរយៈពេលប្រាំឆ្នាំបន្ទាប់ រដ្ឋាភិបាល លន់ នល់ ដែលមានការគាំទ្រពីសហរដ្ឋអាមេរិកបានប្រយុទ្ធក្នុងសមរភូមិដែលចាញ់ប្រឆាំងនឹងខ្មែរក្រហម។ ការទម្លាក់គ្រាប់បែកទ្រង់ទ្រាយធំរបស់សហរដ្ឋអាមេរិកនៅតែបន្ត ហើយចំនួនប្រជាជនក្នុងទីក្រុងបានកើនឡើងនៅពេលដែលជនភៀសខ្លួនបានគេចចេញពីអំពើហិង្សានៅជនបទ។ នៅឆ្នាំ១៩៧៥ ខ្មែរក្រហមបានបន្តចូលមកកាន់កាប់រាជធានីភ្នំពេញបន្តិចម្តងៗដោយគ្មានការឈប់ឈរ។ នៅថ្ងៃទី១៧ ខែមេសា ឆ្នាំ១៩៧៥ ខ្មែរក្រហមបានចូលកាន់កាប់ទីក្រុងភ្នំពេញ ដោយបញ្ចប់សង្គ្រាមស៊ីវិល និងបើកទំព័រប្រវត្តិសាស្ត្រដ៏ខ្មៅងងឹតបំផុតមួយនៅក្នុងប្រវត្តិសាស្ត្រសម័យទំនើបរបស់កម្ពុជា។`
    },
    {
      heading: "កម្ពុជាប្រជាធិបតេយ្យ និងអំពើប្រល័យពូជសាសន៍កម្ពុជា (១៩៧៥–១៩៧៩)",
      body: `ខ្មែរក្រហមដែលដឹកនាំដោយ ប៉ុល ពត បានប្តូរឈ្មោះប្រទេសភ្លាមៗទៅជាកម្ពុជាប្រជាធិបតេយ្យ ហើយបានចាប់ផ្តើមគម្រោងវិស្វកម្មសង្គមដ៏រ៉ាឌីកាល់។ គោលដៅរបស់ពួកគេគឺដើម្បីបង្កើតសង្គមកសិកម្មដែលពឹងផ្អែកលើខ្លួនឯង និងគ្មានវណ្ណៈ។ ពួកគេបានជម្លៀសប្រជាជនរាប់លាននាក់ចេញពីទីក្រុង ដោយបង្ខំឲ្យទៅធ្វើការងារដោយបង្ខំនៅតាមកសិដ្ឋានរួមនៅជនបទ។ ទ្រព្យសម្បត្តិឯកជន លុយ និងសាសនាត្រូវបានលុបបំបាត់ទាំងស្រុង។
        
        ក្នុងអំឡុងពេលដ៏ឃោរឃៅរយៈពេល៤ឆ្នាំនេះ ប្រជាជនកម្ពុជាប្រមាណពី ១.៥ ទៅ ២ លាននាក់ (ស្មើនឹងប្រហែលមួយភាគបួននៃចំនួនប្រជាជនសរុប) បានស្លាប់បាត់បង់ជីវិតដោយសារការអត់ឃ្លាន ការធ្វើការហួសកម្លាំង ជំងឺ និងការប្រហារជីវិត។ របបខ្មែរក្រហមបានកំណត់គោលដៅលើបញ្ញវន្ត ជនជាតិភាគតិច (រួមទាំងជនជាតិចាម និងជនជាតិវៀតណាម) អតីតមន្ត្រីរាជការ និងអ្នកណាដែលត្រូវបានចាត់ទុកថាជា "សត្រូវរបស់រដ្ឋ"។ អំពើឃាតកម្មដ៏សាហាវយង់ឃ្នងបានកើតឡើងនៅទីកន្លែងរាប់រយដែលត្រូវបានគេស្គាល់ថាជាវាលពិឃាត។`
    },
    {
      heading: "ការលុកលុយរបស់វៀតណាម និងជម្លោះដែលអូសបន្លាយ (១៩៧៩–១៩៩៨)",
      body: `ទោះបីជាពួកគេមានមនោគមវិជ្ជាកុម្មុយនិស្តដូចគ្នាក៏ដោយ ទំនាក់ទំនងរវាងខ្មែរក្រហម និងវៀតណាមមានលក្ខណៈអរិភាព។ ខ្មែរក្រហមបានធ្វើការវាយឆ្មក់តាមព្រំដែនញឹកញាប់ចូលទៅក្នុងប្រទេសវៀតណាម ដោយសម្លាប់ជនស៊ីវិល និងបង្កើនភាពតានតឹង។ នៅថ្ងៃទី២៥ ខែធ្នូ ឆ្នាំ១៩៧៨ វៀតណាមបានបើកការលុកលុយទ្រង់ទ្រាយធំលើប្រទេសកម្ពុជា។ ក្នុងរយៈពេលតែពីរសប្តាហ៍ កងទ័ពវៀតណាមបានដណ្តើមបានរាជធានីភ្នំពេញ និងទម្លាក់របបខ្មែរក្រហមពីអំណាច។
        
        វៀតណាមបានដំឡើងរដ្ឋាភិបាលថ្មីមួយគឺសាធារណរដ្ឋប្រជាមានិតកម្ពុជា ដែលមនុស្សជាច្រើនចាត់ទុកថាជារបបអាយ៉ង។ ខណៈដែលការឈ្លានពានរបស់វៀតណាមបានបញ្ចប់អំពើប្រល័យពូជសាសន៍ ប៉ុន្តែវាមិនបានបញ្ចប់ជម្លោះទាំងស្រុងនោះទេ។ សង្រ្គាមទ័ពព្រៃដ៏អូសបន្លាយមួយបានចាប់ផ្តើមរវាងរដ្ឋាភិបាលដែលគាំទ្រដោយវៀតណាម និងក្រុមចម្រុះនៃបក្សពួកតស៊ូចំនួនបី រួមទាំងខ្មែរក្រហមដែលចាញ់ ដែលនៅតែបន្តទទួលបានការគាំទ្រពីប្រទេសចិន សហរដ្ឋអាមេរិក និងប្រទេសថៃ។
        
        សង្គ្រាមទ័ពព្រៃនេះដែលត្រូវបានជំរុញដោយភាពតានតឹងក្នុងសង្គ្រាមត្រជាក់ និងការប្រកួតប្រជែងភូមិសាស្ត្រនយោបាយ បានបន្តពេញមួយទសវត្សរ៍ឆ្នាំ១៩៨០។ វៀតណាមបានដកទ័ពរបស់ខ្លួននៅឆ្នាំ១៩៨៩ ហើយដំណើរការសន្តិភាពក៏ត្រូវបានចាប់ផ្តើមជាស្ថាពរ។ កិច្ចព្រមព្រៀងសន្តិភាពទីក្រុងប៉ារីសឆ្នាំ១៩៩១ បាននាំមកនូវបេសកកម្មរក្សាសន្តិភាពរបស់អង្គការសហប្រជាជាតិ (UNTAC) មកកាន់ប្រទេសកម្ពុជា ដើម្បីដកហូតអាវុធបក្សពួក និងរៀបចំការបោះឆ្នោតដោយសេរី។
        
        ទោះជាយ៉ាងណាក៏ដោយ ក្រុមខ្មែរក្រហមមួយចំនួនបានបដិសេធមិនចូលរួម ហើយនៅតែបន្តប្រយុទ្ធ ដែលធ្វើឲ្យសន្តិភាពមានការរំខាន។ ជម្លោះនេះបានអូសបន្លាយជាច្រើនឆ្នាំទៀត។ ការដួលរលំចុងក្រោយនៃរបបខ្មែរក្រហមបានកើតឡើងនៅពាក់កណ្តាលទសវត្សរ៍ឆ្នាំ១៩៩០ នៅពេលដែលមេដឹកនាំជាន់ខ្ពស់បានផ្តាច់ខ្លួន ហើយ ប៉ុល ពត បានស្លាប់នៅឆ្នាំ១៩៩៨។ ការចាប់ខ្លួនមេដឹកនាំខ្មែរក្រហមចុងក្រោយបង្អស់គឺ តា ម៉ុក ក្នុងឆ្នាំ១៩៩៩ ត្រូវបានគេចាត់ទុកថាជាការបញ្ចប់ទាំងស្រុងនៃសង្គ្រាមស៊ីវិល និងជម្លោះដ៏អូសបន្លាយជាច្រើនទសវត្សរ៍។`
    }
  ]
};
...
const Item5 = () => {
  ...
  return (
    <div className="bg-gray-50 text-gray-800 p-4 px-2 px-1 min-h-screen">
      <style>{`
      ...
      <div className="max-w-7xl mt-7 mx-auto p-4 px-1 md:grid md:grid-cols-2 md:gap-8 lg:gap-12">
        {/* English Title & Intro */}
