...
const Item3 = () => {
  ...
  return (
    <div 
    className="bg-slate-100 min-h-screen p-4 px-1 sm:p-8 md:p-12 text-gray-800">
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 px-2 sm:p-8 md:p-10 rounded-xl shadow-lg">
